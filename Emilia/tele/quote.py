...
async def _quotly_api_(e):
    ...
    try:
        ...
        if photo:
            ...
            qs = await e.respond(file="gay.webp", force_document=photo, buttons=buttons)
        await add_quote(
            e.chat_id,
            [
