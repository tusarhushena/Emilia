...
HELP_IMG = "https://files.catbox.moe/ka9qcw.jpg"
START_IMG = "https://files.catbox.moe/ka9qcw.jpg"
...
if __name__ == "__main__":
    try:
        if ORIGINAL_EVENT_LOOP: # Main Bot
            os.chdir("/root/Emilia/") # Change to your directory where the bot is located on the server
